class BaseCharacter {
  ...
  getHurt(damage){
    ...
    _this.id = setInterval(function(){
      ...
      _this.element.getElementsByClassName("effect-image")[0].src = "img/hero/effect/blade/" + i + ".png";
      i ++;
      if (i > 8){
...
class Hero extends BaseCharacter{
  ...
  getHeal(heal){
    ...
    _this.id = setInterval(function(){
      ...
      _this.element.getElementsByClassName("effect-image")[0].src = "img/hero/effect/heal/" + i + ".png";
